...
file.pathname = "/Users/bingbing/Desktop/EPIC_QC/cpgs_within_0bp_of_TGP_SNP.Rdata"
...
library(data.table)
beta.obj <- fread("/Users/bingbing/Desktop/noob_qcd_crossReactiveProbesRemoved.csv", data.table = F)
...
source("/Users/bingbing/Desktop/EPIC_QC/location.based.pc.R")
...
phen <- read.csv("/Users/bingbing/Desktop/Pheno_QC_1.csv",stringsAsFactors=FALSE,header=TRUE)
phen <- merge(phen,top10pc,by.x = 1,by.y = "row.names",all.x = T)
write.csv(phen, file = "/Users/bingbing/Desktop/Pheno_QC_2.csv",row.names = F) # Save the phenotype file with mPCs
