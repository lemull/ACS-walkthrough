...
pheno <- read.csv("/Users/bingbing/Desktop/Methylation_FV_T_Pre/Methylation_FV_T_Pre_data.csv") # PHENOTYPE FILE - HERE
head(pheno)
pheno$SampleID <- paste(pheno$Sentrix_ID, pheno$Sentrix_Position,sep = "_") # create SampleID by combining Sentrix barcode and Sentrix position

# Read idats
#' Path where you idat files are
#' It can have many subfolders containing idats
main_dir <- "/Users/bingbing/Desktop/Methylation/"  # PATH TO IDATS FOLDER HERE, this is an example path, change accordingly  
